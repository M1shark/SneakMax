...
/* harmony import */ var _components_cart__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_cart__WEBPACK_IMPORTED_MODULE_4__);
...
accordion.forEach(el => {
  el.addEventListener("click", () => {
    ...
    const content = target.querySelector(".questions__content");
...
const mainSlider = document.querySelector(".prod-slider__main .swiper-wrapper");
const previemSlider = document.querySelector(".prod-slider__previem .swiper-wrapper");
const prodModalTitle = document.querySelector(".prod-modal__title");
const prodModalSize = document.querySelector(".modal-size__list");
const prodModalPrice = document.querySelector(".prod-modal__price");
const prodModalCharacteristics = document.querySelector(".prod-сharacteristics__list");
const prodModalVideo = document.querySelector(".prod-modal__vidio");
let prodQuantity = 5;
let dataLength = null;
...
if (catalogList) {
                ...
                <article class="product">
                  <div class="product__img">
                    ...
                    <div class="product__btns">
                      <button class="product__btn btn-reset add-to-cart-btn" data-id="${item.id}">
                        <svg class="">
                          <use xlink:href="img/sprite.svg#cart"></use>
                        </svg>
                      </button>
                      <button class="product__btn btn-reset" data-id="${item.id}" data-graph-path="prod-modal">
                        <svg class="">
                  ...
                  <p class="product__text">${normalPrice(item.price)}р </p>
                </article>
              </li>
            `;
        }
  ...
  const loadModalData = function () {
    ...
    fetch("../data/data.json").then(response => {
      ...
      previemSlider.innerHTML = "";
      prodModalTitle.innerHTML = "";
      prodModalSize.innerHTML = "";
      prodModalPrice.innerHTML = "";
      prodModalCharacteristics.innerHTML = "";
      prodModalVideo.innerHTML = "";
      for (let dataItem of data) {
        if (dataItem.id == id) {
          const slides = dataItem.gallery.map((image, idx) => {
            return `
                <div class="swiper-slide prod-slider__slide" data-index="${idx}">
                  <img src="${image}" alt="">
                </div>
              `;
          });
          const previem = dataItem.gallery.map((image, idx) => {
            return `
              <div class="swiper-slide prod-slider__slide prod-slider__previem-item" data-index="${idx}">
                <img src="${image}" alt="">
              </div>
              `;
          });
          const sizes = dataItem.sizes.map(size => {
            return `
              <li class="modal-size__item">
                <button class="modal-size__btn btn-reset">
                  ${size}
                </button>
              </li>
              `;
          ...
          Object.keys(dataItem.chars).forEach(function eachKey(key) {
            charsItem += `
                <li class="prod-сharacteristics__item">
                  <p class="prod-сharacteristics__text">
                    ${key}: ${dataItem.chars[key]}
                  </p>
                </li>
                `;
          });
          mainSlider.innerHTML = slides.join("");
          previemSlider.innerHTML = previem.join("");
          prodModalTitle.innerHTML = `
            <h2 class="prod-modal__title">
              ${dataItem.title}
            </h2>
            `;
          prodModalSize.innerHTML = sizes.join("");
          prodModalPrice.innerHTML = `
            <div class="prod-modal__price modal-price">
              <span class="modal-price__nov"> ${normalPrice(dataItem.price)}р </span>
              <span class="modal-price__old">${dataItem.oldPrice ? dataItem.oldPrice + "р" : ""}</span>
            </div>
            `;
          prodModalCharacteristics.innerHTML = charsItem;
          if (dataItem.video) {
...
const fullPrice = document.querySelector(".mini-cart-results__price");
...
const loadCartData = function () {
  ...
  fetch("../data/data.json").then(response => {
    ...
    for (let dataItem of data) {
      if (dataItem.id == id) {
        ...
        miniCartList.insertAdjacentHTML("afterbegin", `
            ...
            <article class="mini-cart__body">
              <div class="mini-cart__info">
                <img src="${dataItem.mainImage}" alt="img" class="mini-cart__img">
              ...
              <button class="mini-cart__remove btn-reset">
                <svg class="">
                  <use xlink:href="img/sprite.svg#mini-cart-btn"></use>
                </svg>
              </button>
            </article>
          </li>
    ...
    document.querySelectorAll(".mini-cart__remove").forEach(el => {
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".prod-slider__previem", {
  spaceBetween: 10,
  slidesPerView: 5,
  freeMode: true,
  watchSlidesProgress: true
});
const swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".prod-slider__main", {
  spaceBetween: 10,
  thumbs: {
    swiper: swiper
  }
